                    ...
                    <tr>
                      <td class="sm-px-6" style="padding-left: 40px; padding-right: 40px">
                        <table style="width: 100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td>
                              <a href="https://designer.kastolabs.xyz" class="dark-text-gray-50" style="text-decoration: none; font-weight: 700; color: #191847">
                                Kaseto Labs
                              </a>
                            </td>
                            <td align="right">
                              <a href="https://designer.kastolabs.xyz" class="dark-text-gray-900 dark-bg-gray-50 hover-bg-slate-100" style="text-decoration: none; display: inline-block; border-radius: 8px; background-color: #f9fafb; padding: 7px 12px; text-align: center; font-size: 12px; font-weight: 700; color: #191847; box-shadow: 0px 1px 3px rgba(0, 0, 0, 0.06), 0px 1px 3px rgba(0, 0, 0, 0.1)">
                                <!--[if mso
                                  ]><i
                                    style="
                                      letter-spacing: 24px;
                          ...
                          <tr>
                            <td>
                              ...
                              <p class="dark-text-gray-50" style="margin: 0; font-size: 16px; line-height: 26px; color: #191847">
                                ...
                                n'ayez pas à vous souvenir ou à taper un autre long
                                mot de passe.
                              </p>
                            </td>
                          </tr>
          ...
          <table class="sm-w-full dark-text-gray-200" style="width: 568px; color: #767E9D" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td style="padding-left: 40px; padding-right: 40px">
                <a href="https://designer.kastolabs.xyz" class="dark-text-gray-50" style="text-decoration: none; font-weight: 700; color: #767E9D">
                  Kaseto Labs
                </a>
                ...
                <table class="sm-w-full" style="font-size: 12px; line-height: 16px" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-block sm-w-full">
                      <a href="https://designer.kastolabs.xyz" class="sm-block sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; font-weight: 700; color: #767E9D">
                        Shop
                      </a>
                    </td>
                ...
                <p style="margin: 0; font-size: 12px; line-height: 16px">
                    Si vous avez des questions ou besoin d'aide, n'hésitez pas à contacter notre
                    équipe d'assistance !
                  <br>
                  <br>
                ...
                <table class="sm-w-full" style="font-size: 12px; line-height: 16px" cellpadding="0" cellspacing="0" role="presentation">
                  <tr>
                    <td class="sm-block sm-w-full">
                      <a href="https://designer.kastolabs.xyz" class="sm-py-3 hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; display: block; font-weight: 700; color: #767E9D">
                        Termes &amp; conditions
                      </a>
                    </td>
                    <td class="sm-block sm-px-0" style="padding-left: 12px; padding-right: 12px">
                ...
                <div style="line-height: 16px">&zwnj;</div>
                <p style="margin: 0; font-size: 12px; line-height: 16px">
                    Ce message a été envoyé à name@domain.com. Si vous ne souhaitez plus recevoir
                    ces courriels de Kaseto Labs à l'avenir, vous pouvez
                  <a href="https://designer.kastolabs.xyz" class="hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; font-weight: 700; color: #767E9D">modifier votre profile</a>
                  ou
                  <a href="https://designer.kastolabs.xyz" class="hover-text-slate-600 dark-text-gray-200 dark-hover-text-gray-100" style="text-decoration: none; font-weight: 700; color: #767E9D">desabonner</a>.
                </p>
