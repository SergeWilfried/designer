              ...
              {status === "loading" ? (
                ...
                !originalPhoto && (
                  ...
                  >
                    ...
                    <label for="helper-text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Votre email</label>
                    ...
                    <button
                      laonClick={() => signIn("email")}
                      cssName="bg-gray-200 text-black font-semibold py-3 px-6 rounded-2xl flex items-center space-x-2"
                    >
